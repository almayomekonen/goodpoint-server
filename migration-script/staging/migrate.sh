...
echo_c "This script will fetch a dump from goodpoint1's staging's DB into your local DB."
...
echo -e "${COLOR_ERR}Are you in the ${COLOR_EMPHASIZE}server/migration-script/staging/${COLOR_ERR} directory? ${COLOR_FAINT}[y/n] ${NC}"
read should_run2
...
running_db_name="goodpoint_t"
running_db_user="goodpoint_t@mysql8b"
...
mysqldump -u$running_db_user -pzj69WeGjMRZtK -h$running_db_host $running_db_name > $running_db_dump_path --no-tablespaces
return_code1="$?"
