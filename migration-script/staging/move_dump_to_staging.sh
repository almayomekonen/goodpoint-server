...
staging_database_name="goodpoint2_t"
staging_database_user="goodpoint2_t@mysql8b"
staging_database_password="1hgjlfW3QaRh2"
...
mysql -u$staging_database_user -p1hgjlfW3QaRh2 -h$staging_database_host -e "DROP DATABASE IF EXISTS $staging_database_name; CREATE DATABASE $staging_database_name;"
return_code2="$?"
...
mysql -u $staging_database_user -p1hgjlfW3QaRh2 -h$staging_database_host $staging_database_name <$dump_to_send_to_staging_path
return_code3="$?"
